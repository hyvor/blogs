...
{#if open}
    ...
    <Modal
        title="Update Comments Embed Code"
        bind:show={open}
    >

        <p>
            Your current "Comments Embed Code" is:
        </p>

        <div class="code-block-wrap">
            <CodeBlock 
                code={$blogStore.comments_code || ''}
            />
        </div>

        <p>
            Please confirm that you want to update it to Hyvor Talk embed code.
        </p>
