        ...
        <Table columns="2fr 2fr 3fr 2fr 2fr 2fr 2fr">
            ...
            {#each $linkAnalysisChecks as check (check.id)}
                ...
                <TableRow>
                    ...
                    <div>
                        <time
                            dateTime={dayjs.unix(check.created_at).toISOString()}
                        >
                    ...
                    <div>
                        <div>{check.posts_count} posts ({check.post_variants_count} variants)</div>
                        <div>{check.pages_count} pages ({check.page_variants_count} variants)</div>
                    </div>
