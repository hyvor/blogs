<script lang="ts">
    ...
    function handleChangeEvent(name: WebhookEvent, e: any) {
    ...
    function isEventChecked(name: string) {
        return events.includes(name as WebhookEvent);
    }
...
>
    ...
    <SplitControl 
        label="Webhook URL"
        caption="Must be a valid HTTPS URL"
    >
    ...
    <SplitControl
        label="Events"
        caption="Select the events you want to receive"
    >
