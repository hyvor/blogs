...
<BlogSettingsSave 
    keys={['comments_code', 'newsletter_code']}
/>

<div class="settings">
        
    <SplitControl
        label="Comments Embed Code"
    >
    ...
    <SplitControl
        label="Newsletter Signup Form Code"
    >

        <div slot="caption">

            Paste the embed code provided by a email newsletter service here (for the sign up form). You can use Twig <Link style="display:inline;" href="/docs/themes-templates#variables" target="_blank">route variables</Link> if needed.
        ...
        <div style="margin-top:10px;">
            <Text light small>
                Your theme will decide where to show this form. If you want to show it in a specific place, you may also edit your theme files.
            </Text>
        </div>
