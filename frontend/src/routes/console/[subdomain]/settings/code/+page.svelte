...
<div class="settings">
    ...
    <div class="intro">
        <Callout type="info">
            Head and foot code will be applied to your <strong>whole blog</strong>. See <Link href="https://blogs.hyvor.com/docs/custom-code" target="_blank">docs</Link> for other ways to add custom code. You can use HTML or <Link href="/docs/themes-templates#twig" target="_blank">Twig</Link> in the code fields. <Link href="/docs/themes-templates#variables" target="_blank">These variables</Link> are available in Twig.
        </Callout>
    </div>
    ...
    >
        ...
        <Switch
            ...
            on:change={handleFlashloadChange}
        />
    </SplitControl>
