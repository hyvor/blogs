...
type StoreType<T extends keyof DOMEventMap = keyof DOMEventMap> = 
    Partial<Record<T, ((event: DOMEventMap[T]) => void)[]>>;
...
export function addEditorEventListener<T extends keyof DOMEventMap>(key: T, handler: (e: DOMEventMap[T]) => void) {
...
export function handleEditorEventHandlers<T extends keyof DOMEventMap>(key: T, event: DOMEventMap[T]) {
