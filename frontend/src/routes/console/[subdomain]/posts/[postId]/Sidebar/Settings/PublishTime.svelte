<script lang="ts">
	...
	import { postOriginalStore, postOriginalVariantStore, postStore, postVariantStore, updatePostStore } from "../../../postStore";
    ...
    function handleBlur(e: any) {
        ...
        if (timestamp === $postOriginalStore.published_at)
            return;
