...
test('get link type', () => {
	...
	expect(getLinkType('https://example.com', 'https://blog.example.com/blog')).toBe(
		'internal-root-domain'
	);
	expect(getLinkType('https://example.com/about', 'https://blog.example.com')).toBe(
		'internal-root-domain'
	);
	expect(getLinkType('https://subdomain.example.com', 'https://blog.example.com/blog')).toBe(
		'internal-root-domain'
	);
	...
	expect(getLinkType('https://subdomain.example.com', 'https://blog.hyvor.com/blog')).toBe(
		'external'
	);
	...
	// bug #438
	expect(getLinkType('https://killedbygoogle.com "https://killedbygoogle.com"', baseUrl)).toBe(
		'other'
	);
});
