...
export const nodes = {
	...
	heading: {
		...
		parseDOM: [
			{
				tag: 'h1',
				getAttrs(h: HTMLElement) {
					return { id: h.id, level: 1 };
				}
			},
			{
				tag: 'h2',
				getAttrs(h: HTMLElement) {
					return { id: h.id, level: 2 };
				}
			},
			{
				tag: 'h3',
				getAttrs(h: HTMLElement) {
					return { id: h.id, level: 3 };
				}
			},
			{
				tag: 'h4',
				getAttrs(h: HTMLElement) {
					return { id: h.id, level: 4 };
				}
			},
			{
				tag: 'h5',
				getAttrs(h: HTMLElement) {
					return { id: h.id, level: 5 };
				}
			},
			{
				tag: 'h6',
				getAttrs(h: HTMLElement) {
					return { id: h.id, level: 6 };
				}
			}
		],
		toDOM(node: Node) {
