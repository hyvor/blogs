...
describe('occurrences of keyword', () => {
	...
	test('occurrences of keyword in content', () => {
		...
		expect(getOccurrencesOfKeywordInContent('blogging platform', 'blogging platform')).toBe(1);
		expect(
			getOccurrencesOfKeywordInContent('blogging platform', 'blogging platform blogging platform')
		).toBe(2);
		expect(
			getOccurrencesOfKeywordInContent('blogging platform', 'Hyvor Blogs is a blogging platform')
		).toBe(1);
