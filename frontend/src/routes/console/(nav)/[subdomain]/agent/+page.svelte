<script lang="ts">
	...
	import Compare from '../posts/[postId]/Body/Compare/Compare.svelte';
	...
	const DEFAULT_CONTENT_JSON = '{"type":"doc","content":[{"type":"paragraph","content":[]}]}';
	...
	async function handleSubmit() {
		...
		try {
			await callAgent(userPrompt, (event) => {
...
{#if showCompare && documentChange && postVariant}
	<Compare
		leftTitle="Current Content"
		rightTitle="Suggested Changes"
		leftContent={postVariant.content || DEFAULT_CONTENT_JSON}
