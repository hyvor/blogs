...
<Modal title={i18n.t('console.settings.danger.clearCache')} bind:show>
	<SplitControl label={i18n.t('console.settings.danger.cache.type')}>
		<InputGroup>
			<Radio bind:group={type} value="template">
				{i18n.t('console.settings.danger.cache.typeTemplate')}
			</Radio>

			<Radio bind:group={type} value="paths">
				{i18n.t('console.settings.danger.cache.typePaths')}
			</Radio>

			<Radio bind:group={type} value="all">
				{i18n.t('console.settings.danger.cache.typeAll')}
			</Radio>
		</InputGroup>
	...
	{#if type === 'paths'}
		<SplitControl
			label={i18n.t('console.settings.danger.cache.paths')}
