...
export async function resolveAuthor(author: Author): Promise<AuthorInfo> {
	...
	if (author === 'unknown') {
		return { name: 'Unknown', picture: undefined };
	}
