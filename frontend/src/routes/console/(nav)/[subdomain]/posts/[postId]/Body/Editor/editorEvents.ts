...
export type ProsemirrorEvent<T extends keyof DOMEventMap = keyof DOMEventMap> =
  DOMEventMap[T];

export type ProsemirrorEventDispatchType<
  T extends keyof DOMEventMap = keyof DOMEventMap,
> = {
  view: EditorView;
  name: T;
  event: DOMEventMap[T];
