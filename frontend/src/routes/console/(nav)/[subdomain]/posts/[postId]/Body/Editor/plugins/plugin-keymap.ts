...
import { type Command, EditorState, NodeSelection, Selection, Transaction } from "prosemirror-state";
...
export default function keymapPlugins() {
    ...
    return [keymap(extendedKeymap), keymap(baseKeymap), getCodeBlockKeymap(), getShortcutKeymap(schema)];
}
