...
<TabNav>
    ...
    <TabNavItem
    	...
    	onclick={() => (active = 'analytics')}>Analytics</TabNavItem
    >

    <TabNavItem
    	name="memberships"
    	active={active === 'memberships'}
    	onclick={() => (active = 'memberships')}>Memberships</TabNavItem
    >
...
<p>A newsletter is a great way to build an audience and share valuable information.</p>
    	...
    	<p>
    		We are not affiliated with any of these services. There are plenty of other newsletter
...
<div>
<p>
It is cool to know some metrics about how much traffic your blog gets. You can easily
integrate analytic services to the blog using custom code.
</p>
...
to do that.
    	...
    	<ul>
    		...
    		<ul>
    			<li>
    				To add a form to a post or page, use <a href="/docs/writing#custom-html"
    					>custom HTML/Twig blocks</a
    				>.
    			</li>
    			<li>
    				To add a form to a specific place in the blog, you will need to <a
    					href="/docs/theme#editing">edit the theme</a
    				>.
    			</li>
    		</ul>
    	</ul>
