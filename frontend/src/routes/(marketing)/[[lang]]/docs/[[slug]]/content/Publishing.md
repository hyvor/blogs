...
As explained in the [configurations](/docs/themes-config) page, the following configurations are required when publishing your theme.
...
Add a `CHANGELOG.md` file to your theme folder and add the changes for each version. See <a href="https://keepachangelog.com/en/1.1.0/" rel="nofollow">keepachangelog.com</a> to learn how to write a changelog.
