...
If you are already using Docker within your website, you can use our official Docker image to host your Hyvor Blog in a subdirectory. You can use a reverse proxy like Caddy, Nginx or Traefik to route blog traffic to the Docker container.
...
If you are already using Cloudflare for your domain, using <a href="https://workers.cloudflare.com/" rel="nofollow" target="_blank">Cloudflare Workers</a> is by far the easiest method to host your blog in a subdirectory. You can set it up in a couple of minutes without writing a single line of code.
...
- [Delivery API](/docs/api-delivery) - Learn how to serve a request from your framework.
- [Webhooks](/docs/webhooks) - Use to invalidate cache when the blog is updated.
