...
<p>
	...
	writing. Some of the SEO features can be configured in <strong
		>Console &rarr; Settings &rarr; SEO</strong
	>.
</p>
...
<p>These are the basic meta tags that are added to all pages in your blog.</p>
...
<p>
	If you have <a href="/docs/languages">set up multiple languages</a>, Hyvor Blogs will
	automatically add <code>hreflang</code> tags to index and post pages.
</p>
...
<p>These tags help social media sites to generate rich previews of your blog and posts.</p>
...
<p>
	A rich schema of <a
		...
		target="_blank"
		rel="nofollow">BlogPosting</a
	> is added to all posts. This helps search engines to understand your posts better and display them
...
<p>
	Rich schema is added to all posts by default, but you can turn it off at <strong
		>Console &rarr; Settings &rarr; SEO</strong
	>.
</p>
...
<p>
	Hyvor Blogs follows one principle when it comes to canonical URLs: <strong
		>One URL for one content</strong
	>. A post will be accessible from only one URL. This basic principle helps you avoid common
...
<p>Default robots.txt file is as follows:</p>
...
<p>
	Hyvor Blogs generates sitemaps automatically. You can find the <a
		href="https://www.sitemaps.org/protocol.html#index"
		target="_blank"
...
<p>The sitemap index links to other sitemaps of the blog.</p>
...
<p>This is the meta tag you can use to prevent search engines from indexing a page.</p>
...
<p>
	To prevent search engines from indexing your <strong>whole blog</strong>, turn off the
	<strong>Settings → SEO → Allow Indexing</strong>
	option. Hyvor Blogs will add the above meta tag to all pages. You can also add this meta tag manually
	to your theme or head <a href="/docs/custom-code">custom code</a>.
</p>

<h3 id="whole-blog">2. Specific post</h3>

<p>
	To prevent a post from indexing, you can add the above meta tag to the post's head <a
		href="/docs/custom-code#post">custom code</a
	>.
</p>
