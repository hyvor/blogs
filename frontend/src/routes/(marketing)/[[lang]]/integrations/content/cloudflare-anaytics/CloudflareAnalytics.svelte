...
<div class="guide-content">
	...
	<ol>
		...
		<DocsImage
			src="/images/integrations/content/cloudflare-anaytics/analytics.png"
			alt="Cloudflare Analytics"
			width={300}
		/>
		<li>Click <b>Add a Site</b>.</li>
		<DocsImage
			src="/images/integrations/content/cloudflare-anaytics/web-analytics-add-a-site.png"
			alt="Add a site"
		/>
		<li>
		...
		<DocsImage
			src="/images/integrations/content/cloudflare-anaytics/existing-domain-done.png"
			alt="Add a site"
		/>
		<p>
		...
		<DocsImage
			src="/images/integrations/content/cloudflare-anaytics/view-analytics.png"
			alt="View Analytics"
		/>
	</ol>
	...
	<ol>
		...
		<li>
			...
			<DocsImage
				src="/images/integrations/content/cloudflare-anaytics/add-new-site.png"
				alt="Add new site"
			/>
		</li>
		<li>Copy the given code</li>
		<DocsImage
			src="/images/integrations/content/cloudflare-anaytics/copy-js-code.png"
			alt="Copy JS code"
		/>
	</ol>
	...
	<ol>
		...
		<DocsImage
			src="/images/integrations/content/cloudflare-anaytics/paste-js-code.png"
			alt="Paste JS code"
		/>
	...
	<DocsImage
		src="/images/integrations/content/cloudflare-anaytics/analytics-overview.png"
		alt="View Analytics"
	/>
</div>
