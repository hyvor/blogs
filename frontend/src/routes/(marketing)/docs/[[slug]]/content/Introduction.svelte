...
<p>Hi there blogger 👋,</p>

<p>
	Running a blog has never been easier. Installing plugins, keeping up with updates, and managing
	services are not for general bloggers. We believe that blogging should be easy for everyone.
...
<p>
	Hyvor Blogs is an all-in-one blogging platform. Here are some of its main features with links to
...
<ul>
	...
	<li>
		...
		ads, or other integrations? Just add the code snippet to the Custom Code section.
	</li>
</ul>
...
<p>
	We are working on many new features to make blogging easier. Here are some of them. If you have
...
<p>If you have any questions or feedback, feel free to contact us anytime.</p>

<ul>
	<li>Live chat on the bottom right corner</li>
	<li>
		<a href="mailto:blogs.support@hyvor.com"> blogs.support@hyvor.com </a>
	</li>
</ul>

<p>You can also share your reviews on the following platforms.</p>
