...
<h3 id="content-exclude">
    Exclude content
</h3>

<p>
    You can exclude some parts of your content using CSS selectors. For example, if you have ads in your blog posts, you can exclude them by adding a CSS selector to <strong>Post Content Exclude</strong>:
</p>
