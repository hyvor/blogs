...
<p>
    According to most SEO experts, a subdirectory like <code>/blog</code> is the best place to host your blog. Hyvor Blogs supports multiple methods to host your blog in a subdirectory.
</p>
...
<ul>
    <li>
        <a href="/docs/api-delivery">
            Delivery API
        </a> - Learn how to serve a request from your framework.
    </li>
    <li>
        <a href="/docs/webhooks">
            Webhooks
        </a> - Use to invalidate cache when the blog is updated.
    </li>
</ul>
