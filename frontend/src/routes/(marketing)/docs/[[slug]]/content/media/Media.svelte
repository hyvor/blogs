<script>
	...
	import { IconLightbulb } from "@hyvor/icons";
</script>

<h1>Media</h1>

<p>
    "Media" refers to the files you upload in your blog. It can be images, videos, audio, or any other file. Visit <strong>Tools &rarr; Media Library</strong> to manage your blog media.
</p>
...
<ul>
    ...
    <li>JPEG - <code>.jpg</code>, <code>.jpeg</code>, <code>.jfif</code>, <code>.pjpeg</code>, <code>.pjp</code></li>
...
<p>
    Hyvor Blogs handles responsive images for you. Here's how it works. Images (PNG, JPEG, WebP only) uploaded to the media library can be automatically resized by appending <code>{`/{width}w`}</code> to the URL.
</p>
