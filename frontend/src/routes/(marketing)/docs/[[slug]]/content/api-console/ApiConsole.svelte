...
<p>
	Console API allows you to do administrative tasks of a blog. This is the same API we use
	internally in the Console. You can use it to automate some tasks or even build a completely new
	mini-console by yourself.
</p>
...
<ul>
	...
	<li>
		Create a Console API Key from the Console and send it as the <code>X-API-KEY</code> header.
	</li>
	...
	<li>
		In this documentation, objects, request params, and responses are written as <a
...
<p>[Coming soon]</p>
<p>
	Currently, the Console API is always authenticated as the owner of the blog. We will add
	authentication as other <a href="/docs/users">users</a> soon.
</p>
