...
<div class="hds-box hurry" bind:this={mainEl}>
	...
	<div class="temp-note">Temporary blogs are deleted after 24 hours.</div>
</div>

{#if showFixed}
	<div class="fixed" bind:this={fixedEl} transition:slide={{ duration: 200 }}>
		<div class="hds-container inner">
			<div class="desktop">
				Try Hyvor Blogs with a free temporary blog. <strong>No sign up required</strong>.
			</div>

			<div class="mobile">In a hurry?</div>
			...
			>
				...
				<span class="mobile"> Create temp blog </span>
				{#snippet end()}
					<IconBoxArrowUpRight size={10} />
				{/snippet}
			</Button>
