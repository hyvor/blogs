...
export const categories: Catergory[] = [
  ...
  },
  {
    ...
    title: "Comments",
    integrations: integrations.filter(
      (integration) => integration.category === "comments",
    ),
  },
  {
    name: "newsletters",
    title: "Newsletters",
    integrations: integrations.filter(
      (integration) => integration.category === "newsletters",
    ),
  },

  {
    ...
    title: "Ads",
    integrations: integrations.filter(
      (integration) => integration.category === "ads",
    ),
  },
...

  {
    ...
    title: "Forms",
    integrations: integrations.filter(
      (integration) => integration.category === "forms",
    ),
  },
];
