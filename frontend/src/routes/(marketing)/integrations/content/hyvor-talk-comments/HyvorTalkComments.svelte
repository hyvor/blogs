<script lang="ts">
    ...
    import connectHyvorTalkImg from "./connect-hyvortalk.png";
...
<div class="guide-content">
    ...
    <ol>
        ...
        <ol>
            ...
            <li>Copy the code and paste it on "Comments Embed Code", then click "<b>Save</b>".</li>
        </ol>
        <DocsImage src={pasteCodeImg} alt="Paste Code" />

        <p>That's it! You have successfully connected Hyvor Talk to your Hyvor Blogs. Now, you can manage your comments from the <a href="https://talk.hyvor.com/console">Hyvor Talk dashboard</a>.</p>
        <DocsImage src={verifyImg} alt="Verify" height={500} />
