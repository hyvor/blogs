...
<div class="guide-content">
	<Callout type="info">
		...
		<ul>
			<li>
				a <a href="https://www.cloudflare.com">Cloudflare account</a> to use the Cloudflare Analytics
				tools.
			</li>
	...
	<ol>
		...
		<p>
			Now you can see your site has been added.You can check it by going to <b
				>Analytics & Logs &rarr; Web Analytics</b
			>.
		</p>
	...
	<ol>
		...
		<DocsImage src={webAnalyticsAddSiteImg} alt="Add a site" />
		<li>
			Enter your blog URL (ex:<code>myawesomeblog.hyvorblogs.io</code> or
			<code>myawesomeblog.com</code>).
			<ol>
				<li>
	...
	<p>
		After you added the code, you can verify it by going to <b
			>Analytics & Logs &rarr; Web Analytics</b
		>.
	</p>
