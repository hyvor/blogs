...
class PostObject
{
    ...
    public function __construct(
        ...
        $this->updated_at = ($contentUpdatedAt ?? $variant->getPublishedAt() ?? $post->getUpdatedAt())->getTimestamp();
        $this->published_at = ($variant->getPublishedAt() ?? $post->getCreatedAt())->getTimestamp();
