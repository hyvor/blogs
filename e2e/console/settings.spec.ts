...
test.describe('General Settings', () => {
    ...
    consoleTest('Main language', async ({testingApi, console, page}) => {
    ...
    consoleTest('Secondary language', async ({testingApi, console, page}) => {
        ...
        await expect(page.getByTestId('settings-saved-icon')).toBeVisible();
        await page.reload();
        await page.locator('span').filter({ hasText: 'en' }).nth(3).click();
